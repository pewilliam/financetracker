...
from app.routers import auth, budgets, cards, categories, installments, invoices, months, receivables, recurrences, simulations, subscriptions, transactions, wallets
