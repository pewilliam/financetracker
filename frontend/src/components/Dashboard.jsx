          ...
          <section className="card chart-card dashboard-balance-card">
            <div className="dashboard-card-head balance-head">
              ...
              <div className="balance-head-summary">
                <span>
                  <small>{copy("Início", "Opening")}</small>
                  <strong>
                    {formatMoney(monthData?.opening_balance, language)}
                  </strong>
                </span>
                ...
                <span>
                  <small>
                    {copy(
                      viewingCurrentMonth ? "Saldo atual" : "Saldo inicial",
                      viewingCurrentMonth ? "Current" : "Opening"
                    )}
                  </small>
                  <strong>
                    {formatMoney(safeSummary.current_balance, language)}
                  </strong>
                </span>
